...
class SymbolResourceLocatorTest {
    ...
    fun overlayResources() {
        ...
        assertEquals("symbol_216", locator.getOverlayResourceName(symbolOf('z', '9')))
    ...
    fun unsupportedOverlay() {
        ...
        assertNull(locator.getOverlayResourceName(symbolOf('1', 'A')))
        assertNull(locator.getOverlayResourceName(symbolOf('B', 'Z')))
    }
}
